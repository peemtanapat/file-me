...
export const GET_FILES_URL = `${FILE_SERVICE_URL}/files`
export const UPLOAD_FILES_URL = `${FILE_SERVICE_URL}/files/upload`
export const DOWNLOAD_FILE_URL = `${FILE_SERVICE_URL}/files/download`
export const DELETE_FILE_URL = `${FILE_SERVICE_URL}/files/delete`
